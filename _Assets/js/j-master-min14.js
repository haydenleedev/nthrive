...
}); var num = ($("#section-1").length > 0) ? ($('[id^="section-"]:not("#section-1")')[0]) : $('[id^="section-"]'); $(".skip-to-main").attr("href", "#" + num); $(".ask-a-question[href=\"mailto:experts@answers-nthrive.com\"], .chat-us-now[href=\"mailto:experts@answers-nthrive.com\"], #open-video").click(function () { $("body").addClass("no-scroll"); }); $(".popup-option-overlay, .popup-close").click(function () { $("body").removeClass("no-scroll"); }); (function (factory) { 'use strict'; if (typeof define === 'function' && define.amd) { define(['jquery'], factory); } else if (typeof exports !== 'undefined') { module.exports = factory(require('jquery')); } else { factory(jQuery); } }(function ($) {
