...
function videoClose() { location.reload(); } !(function (root, factory) { if (typeof define === 'function' && define.amd) { define(['jquery'], function ($) { return factory(root, $); }); } else if (typeof exports === 'object') { factory(root, require('jquery')); } else { factory(root, root.jQuery || root.Zepto); } })(this, function (global, $) {
    ...
    $('a').on('keyup change', function (e) { $('a').attr("data-focus", "none"); if (e.keyCode === 9 && $(this).is(":focus")) { $(this).attr("data-focus", "focused"); } }); $('button').attr("data-focus", "none"); $('button').on('keyup change', function (e) { $('button').attr("data-focus", "none"); if (e.keyCode === 9 && $(this).is(":focus")) { $(this).attr("data-focus", "focused"); } }); $(document).on('keydown', function (e) {
