...
function videoClose() { location.reload(); } !(function (root, factory) { if (typeof define === 'function' && define.amd) { define(['jquery'], function ($) { return factory(root, $); }); } else if (typeof exports === 'object') { factory(root, require('jquery')); } else { factory(root, root.jQuery || root.Zepto); } })(this, function (global, $) {
    ...
    $("a").attr("data-focus", "none"); $("button").attr("data-focus", "none"); var $nthMenuAnchor = $('#nth-menuanchor-open'); var $notOpen = $('#primary-nav > ul > li:not(#nth-menuanchor-open)'); $('html').removeClass('no-js'); $nthMenuAnchor.on('click', function () {
    ...
    $('a').on('keyup change', function (e) { $('a').attr("data-focus", "none"); if (e.keyCode === 9 && $(this).is(":focus")) { $(this).attr("data-focus", "focused"); } }); $('button').on('keyup change', function (e) { $('button').attr("data-focus", "none"); if (e.keyCode === 9 && $(this).is(":focus")) { $(this).attr("data-focus", "focused"); } }); $(document).on('keydown', function (e) {
