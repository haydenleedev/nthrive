...
$(document).ready(function () {
    ...
    $box.hover(function (e) {
        if ($(this).attr('aria-expanded') == 'false') {
            ...
            // $(this).children($animWrap).stop(true, true).animate({ left: "237px" }, "fast");
            // $(this).children($over).stop(true, true).delay(100).animate({ left: "0" }, "fast");
        } else {
            $(this).attr('aria-expanded', 'false');
            $($over).attr('aria-hidden', 'true');
            $(this).siblings().attr('aria-expanded', 'false');
            $($over).siblings().attr('aria-hidden', 'true');
            //  $(this).children($animWrap).stop(true, true).delay(100).animate({ left: "0" }, "fast");
            //  $(this).children($over).stop(true, true).animate({ left: "-237px" }, "fast");
        }
        e.stopPropagation();
        return false;
    });
