...
$(document).ready(function() {
    $('.first:has(".panel-wrap")').on('keyup click', function(e) {
        if (e.keyCode === 9) {
            ...
            $(this).children('.panel-wrap').addClass("open").attr('aria-expanded', true).attr('aria-hidden', false);
        }
    });
    $('.first').not(':has(".panel-wrap")').on('keyup not click', function(e) {
        if (e.keyCode === 9) {
            $(this).children('a').addClass("open").attr('aria-expanded', true);
            $('.panel-wrap').removeClass("open");
            $(this).children('.panel-wrap').addClass("open").attr('aria-expanded', true).attr('aria-hidden', false);
    ...
    $(".country").click(function() {
        ...
        $(".intl-tel-input").removeClass("dial-us").removeClass("dial-" + $dialCode).addClass("dial-" + $dialCode);
    });
    if ($(".dial-us input[type='tel']").length) {
        $(".dial-us input[type='tel']").attr("onkeydown", "javascript:backspacerDOWN(this,event);").attr("onkeyup", "javascript:backspacerUP(this,event);");
    }
    $.validator.addMethod("alphabetFormat", function(value, element) {
    ...
    AccessibleMegaMenu.prototype = (function() {
        ...
        _togglePanel = function(event, hide) {
            ...
            if (hide) {
                ...
                var $openParent = $('.' + settings.panelClass + '.' + settings.openClass).parent();
...
(function(window, $, undefined) {
    ...
    Socials.prototype = {
        ...
        _render: function() {
            ...
            this._$shares = $("<ul>").addClass(this.sharesClass).appendTo(this._$element);
            this._renderShares();
        },
...
jQuery.fn.nTicker = function(settings) {
    ...
    return this.each(function() {
        ...
        if (settings.buttons) {
            var $buttons = j('<ul class="ticker-controls">' + '<li class="prev nthriveticker nthriveticker-left"></li>' + '<li class="pause nthriveticker nthriveticker-pause"></li>' + '<li class="next nthriveticker nthriveticker-right"></li>' + '</ul>');
...
$("#back").click(function() {
    $(this).parent('div').parent('div').parent("div.l-double-width").animate({
        left: '0'
    }, "fast");
});
...
$("#form-next").click(function() {
    ...
    if ($("input#question-field").valid()) {
        $(this).parent('div').parent('div').parent('div').parent("div.l-double-width").animate({
            left: '-100%'
        }, "fast");
...
$('#privacy-policy-footer').on('focus', function() {
    $("#question-field").removeClass("error").next("label").attr("id", "question-field").removeClass("error").addClass("label-focus");
    $("#next-button").attr("aria-hidden", "true");
    $("#next-button").addClass("hidden");
});
$(document).ready(function() {
...
$(function() {
    var $colOneTitle = $(".table-body.rev-table.l-list-two-col.text-white > li:first-child > p").html();
    var $colTwoTitle = $(".table-body.rev-table.l-list-two-col.text-white > li:last-child > p").html();
    var added = false;

    function checkSize() {
        if (!added && $(window).width() < 840) {
            $(".table-body.rev-table.bg-ffffff > li:first-child ").prepend("<p class=\"desktop-hide\">" + $colOneTitle + "</p>");
            $(".table-body.rev-table.bg-ffffff > li:last-child").prepend("<p class=\"desktop-hide\">" + $colTwoTitle + "</p>");
            added = true;
        }
    }
