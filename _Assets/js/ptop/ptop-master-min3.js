...
(this, function (global, $) {
    ...
    $(window).scroll(function () { var y = $(this).scrollTop(); if (y >= 446) { $('#page-nav').addClass('fixed'); $('.logo-anim').addClass('move'); } else { $('#page-nav').removeClass('fixed'); $(".logo-anim").removeClass('move'); } }); $('a').on('keydown', function (e) { if (e.keyCode === 9) { $('body').addClass("tab"); } }); $('a').on('keyup', function (e) { if (e.keyCode === 9) { $('body').addClass("tab"); } }); $('button').on('keydown', function (e) { if (e.keyCode === 9) { $('body').addClass("tab"); } }); $('button').on('keyup', function (e) { if (e.keyCode === 9) { $('body').addClass("tab"); } }); $(".logo-wrap").prepend("<div id=\"toggleMenu\" role=\"button\" aria-controls=\"main-nav\"> <a href=\"#\"><span class=\"icon-menu\">&#9776;</span><span class=\"icon-menu-closed\">X</span></a></div>"); $("#main-nav").attr("aria-labelledby", "main-nav-label").attr("role", "region"); $('li.nav-top-level:has("div.panel-wrap")').on('keyup click', function (e) { if (e.keyCode === 9) { $(this).children('a').addClass("open").attr('aria-expanded', true); $('div.panel-wrap').removeClass("open"); $(this).children('div.panel-wrap').addClass("open").attr('aria-expanded', true).attr('aria-hidden', false); } }); $('li.nav-top-level').not(':has("div.panel-wrap")').on('keyup not click', function (e) { if (e.keyCode === 9) { $('div.panel-wrap').removeClass("open").attr('aria-expanded', false); } }); $(document).on('keydown', function (e) { if (e.keyCode === 27) { $('div.panel-wrap').removeClass("open").attr('aria-expanded', false); } }); $('html').removeClass('no-js'); $('#toggleMenu').on('click', function () { $('body').toggleClass('m-open'); $('.main-nav').attr('aria-expanded', function (i, attr) { return attr == 'true' ? 'false' : 'true' }); return false; }); $(".nth-link-search").click(function (e) { $("#primary-nav").toggleClass("search-open"); e.stopPropagation(); }); $("#nth-searchview").click(function (e) { e.stopPropagation(); }); $(document).click(function () { $("#primary-nav").removeClass("search-open"); }); $("#nth-searchview-close").click(function (e) { $("#primary-nav").removeClass("search-open"); }); var visited = $.cookie('visited'); if (visited == 'yes') { $('body').removeClass("notification-close").addClass("notification-close"); return false; } else { $('body').removeClass("notification-close"); }
});