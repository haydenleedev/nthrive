...
; (function ($, w, undefined) {
    ...
    function Sly(frame, options, callbackMap) {
        ...
        function slideTo(newPos, immediate, dontAlign) {
            ...
            $wheelNav.children("button").removeClass("active");
            var wheelData = $("#wheel-co-wrap").find('.active').data("wheel-item");
            $wheelNav.children("button[data-wheel-item = " + wheelData + "]").addClass('active');
            ...
            var $vSlideDataItem = $vSlideWrap.find(".active").data("vslide-item");
        ...
        function scrollHandler(event) {
            ...
            if (o.scrollTrap || delta > 0 && pos.dest == pos.start || delta < 0 && pos.dest == pos.end) {
                $('html, body').animate({
