...
; (function ($, w, undefined) {
    ...
    function Sly(frame, options, callbackMap) {
        ...
        function slideTo(newPos, immediate, dontAlign) {
            ...
            $(".v-slide").find(".btn").attr("tabindex", -1);
            $(".v-slide").children("ul").find(".active").children("div").find(".btn").attr("tabindex", 0);
            $(".v-slide").children(".pages").find(".active").attr("aria-selected", true);
