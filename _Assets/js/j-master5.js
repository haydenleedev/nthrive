...
$(document).ready(function () {
    ...
    // First Name, Last Name: Capitalize the first character
    ...
    $(document).on('keyup', 'keydown', ".dial-us input[type='tel']", function () {
        backspacerDOWN($(this), event);
    });

    /*
    $(".dial-us input[type='tel']").keypress(function (e) {
