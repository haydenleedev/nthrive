; (function ($, window, document, undefined) {
    var pluginName = 'navTarget', defaults = { triggerEvent: "hover", rowSelector: "> li", handle: "> a", submenuSelector: "*", submenuDirection: "right", openClassName: "open", tolerance: 75, activationDelay: 300, mouseLocsTracked: 3, defaultDelay: 300, enterCallback: $.noop, activateCallback: $.noop, deactivateCallback: $.noop, exitCallback: $.noop, exitMenuCallback: $.noop }; function Plugin(el, options) { this.el = el; this.options = $.extend({}, defaults, options); this._defaults = defaults; this._name = pluginName; this.init(); }
    Plugin.prototype = {
        init: function () {
        this.activeRow = 1, this.mouseLocs = [], this.lastDelayLoc = null, this.timeoutId = null, this.openDelayId = null, this.isOnClick = $.inArray(this.options.triggerEvent, ['both', 'click']) > -1, this.isOnHover = $.inArray(this.options.triggerEvent, ['both', 'hover']) > -1; if (this.isOnHover) { this._hoverTriggerOn(); }
