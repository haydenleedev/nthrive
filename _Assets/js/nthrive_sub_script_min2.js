$(document).ready(function () { $('.nav-dropdown').hover(function () { $(this).children('.sub-menu').fadeIn('fast'); $(this).children('.uparrow').fadeIn('fast'); }, function () { $(this).children('.sub-menu').fadeOut('fast'); $(this).children('.uparrow').fadeOut('fast'); }); }); (function (factory) { 'use strict'; if (typeof define === 'function' && define.amd) { define(['jquery'], factory); } else if (typeof exports !== 'undefined') { module.exports = factory(require('jquery')); } else { factory(jQuery); } }(function ($) {
    ...
    $('.home-slider').on('init', function (ev, el) { $('video').each(function () { this.play(); }); }); $('.home-slider').slick({ arrows: false, infinite: true, autoplay: true, pauseOnFocus: false, dots: true, fade: true, autoplaySpeed: 6000, speed: 400 }); $('.home-slider').on('afterChange', function (event, slick, currentSlide) {
...
function videoClose() { location.reload(); } !(function (root, factory) { if (typeof define === 'function' && define.amd) { define(['jquery'], function ($) { return factory(root, $); }); } else if (typeof exports === 'object') { factory(root, require('jquery')); } else { factory(root, root.jQuery || root.Zepto); } })(this, function (global, $) {
...
}; $(document).ready(function () { $(':input', 'form').not(':button, :submit, :reset, :hidden').val('').prop('checked', false).prop('selected', false); }); $("#form-next").click(function () { if ($("input[name=Contact_me_Details__c]").valid()) { $(this).parent('div').parent('div').parent('div').parent("div.l-double-width").animate({ left: '-100%' }, "fast"); } }); $("#back").click(function () { $(this).parent('div').parent('div').parent("div.l-double-width").animate({ left: '0' }, "fast"); }); $(document).ready(function () { $("#mktoForm_604").validate({ messages: { FirstName: { required: !0, minlength: 3 }, LastName: { required: !0, minlength: 3 }, Email: { required: !0, email: !0 }, Contact_me_Details__c: { required: !0, minlength: 5 } }, messages: { FirstName: { required: "Please enter your first name", minlength: "Your first name must consist of at least 3 characters" }, LastName: { required: "Please enter your last name", minlength: "Your last name must consist of at least 3 characters" }, Email: "Please enter a valid email address", Contact_me_Details__c: { required: "Please enter your question", minlength: "Your question must consist of at least 5 characters" } } }) }); $(document).ready(function () { $("#mktoForm_602").validate({ messages: { FirstName: { required: !0, minlength: 3 }, LastName: { required: !0, minlength: 3 }, Email: { required: !0, email: !0 }, Contact_me_Details__c: { required: !0, minlength: 5 }, Email_Opt_in__c: "required" }, messages: { FirstName: { required: "Please enter your first name", minlength: "Your first name must consist of at least 3 characters" }, LastName: { required: "Please enter your last name", minlength: "Your last name must consist of at least 3 characters" }, Email: "Please enter a valid email address", Contact_me_Details__c: { required: "Please enter your question", minlength: "Your question must consist of at least 5 characters" }, Email_Opt_in__c: "Please accept our policy" } }) }); $(document).ready(function () { $("#mktoForm_437").validate({ messages: { FirstName: { required: !0, minlength: 3 }, LastName: { required: !0, minlength: 3 }, Email: { required: !0, email: !0 }, Contact_me_Details__c: { required: !0, minlength: 5 }, Email_Opt_in__c: "required" }, messages: { FirstName: { required: "Please enter your first name", minlength: "Your first name must consist of at least 3 characters" }, LastName: { required: "Please enter your last name", minlength: "Your last name must consist of at least 3 characters" }, Email: "Please enter a valid email address", Contact_me_Details__c: { required: "Please enter your question", minlength: "Your question must consist of at least 5 characters" }, Email_Opt_in__c: "Please accept our policy" } }) }); $(document).ready(function () {
    ...
    }; $('input[name="first_name"]').on('keyup', function () { $(this).capitalize(); }).capitalize(); $('input[name="last_name"]').on('keyup', function () { $(this).capitalize(); }).capitalize(); $('input[name="company"]').on('keyup', function () { $(this).capitalize(); }).capitalize(); $("input[type='tel']").intlTelInput({ initialCountry: "us", preferredCountries: ['us'], autoPlaceholder: "off", placeholderNumberType: "MOBILE" }); $(".country").click(function () { $dialCode = $(".highlight").data("country-code"); console.log($dialCode); $(".intl-tel-input").removeClass("dial-us").removeClass("dial-" + $dialCode).addClass("dial-" + $dialCode); }); $(".dial-us input[type='tel']").keypress(function (e) {
        if ($(".dial-us").length) {
            if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) { return false; }
            var curchr = this.value.length; var curval = $(this).val(); if (curchr == 3 && curval.indexOf("(") <= -1) { $(this).val("(" + curval + ")" + " "); } else if (curchr == 4 && curval.indexOf("(") > -1) { $(this).val(curval + ")-"); } else if (curchr == 5 && curval.indexOf(")") > -1) { $(this).val(curval + "-"); } else if (curchr == 9) { $(this).val(curval + "-"); $(this).attr('maxlength', '14'); }
        }
    ...
    }, "Please do not use all caps."); $.validator.addMethod("notEqual", function (value, element, options) { var elems = $(element).parents('form').find(options[0]); var valueToCompare = value; var matchesFound = 0; jQuery.each(elems, function () { thisVal = $(this).val(); if (thisVal == valueToCompare) { matchesFound++; } }); if (this.optional(element) || matchesFound <= 1) { return true; } else { } }, "Please enter a Unique Value."); $(".t-form").validate({ rules: { first_name: { required: true, minlength: 2, alphabetFormat: true, hasLowercase: true, notEqual: ['.std-input3'] }, last_name: { required: true, minlength: 2, alphabetFormat: true, hasLowercase: true, notEqual: ['.std-input3'] }, email: { required: !0, email: !0 } }, messages: { first_name: { required: "Please enter your first name", minlength: "Your first name must consist of at least 2 characters", alphabetFormat: "No special characters.", hasLowercase: "Please do not use all caps. (i.e. John).", notEqual: "First Name cannot be the same as Last Name" }, last_name: { required: "Please enter your last name", minlength: "Your last name must consist of at least 2 characters", alphabetFormat: "No special characters.", hasLowercase: "Please do not use all caps. (i.e. Doe).", notEqual: "First Name cannot be the same as Last Name" }, email: "Please enter a valid email address", } }); $("#mktoForm_437_2").validate({ messages: { FirstName: { required: !0, minlength: 3 }, LastName: { required: !0, minlength: 3 }, Email: { required: !0, email: !0 }, Contact_me_Details__c: { required: !0, minlength: 5 }, Email_Opt_in__c: "required" }, messages: { FirstName: { required: "Please enter your first name", minlength: "Your first name must consist of at least 3 characters" }, LastName: { required: "Please enter your last name", minlength: "Your last name must consist of at least 3 characters" }, Email: "Please enter a valid email address", Contact_me_Details__c: { required: "Please enter your question", minlength: "Your question must consist of at least 5 characters" }, Email_Opt_in__c: "Please accept our policy" } })
}); $(document).ready(function () { $('form :input').focus(function () { $(this).parent().addClass("valid-group").children('label.label-focus').removeClass("label-focus").addClass("label-blur"); }); $('form :input').blur(function () { $(this).next('label.label-blur').removeClass("label-blur").addClass("label-focus"); }); $('#mktFrmSubmit').on('click', function () { $(this).parent().parent().parent().addClass("valid-group"); }); }); $(document).ready(function () { $('.video.smheight').matchHeight(); $('.smheight').matchHeight(); $('.smheight .story_content').matchHeight(); $('.l-list-two-col .box-container').matchHeight(); }); (function ($) {
    "use strict"; var oldIE; if ($('html').is('.ie6, .ie7, .ie8')) { oldIE = true; }
    if (oldIE) { } else { $("#share-sns").nSocials({ showLabel: false, shares: [{ share: "linkedin", logo: "//www.nthrive.com/_assets/images/icon/share1.png" }, { share: "twitter", logo: "//www.nthrive.com/_assets/images/icon/share2.png" }, { share: "facebook", logo: "//www.nthrive.com/_assets/images/icon/share3.png" }] }); }
}(jQuery));